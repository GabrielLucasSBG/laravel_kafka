...
return [
    ...
    'consumer_timeout_ms' => env("KAFKA_CONSUMER_DEFAULT_TIMEOUT", 1000),

    'consumers' => [
        [
            'topic' => 'user_registered',
            'group_id' => env('KAFKA_CONSUMER_GROUP_ID', 'user-group'),  // Alterando para o mesmo nome de grupo
            'handler' => \App\Consumers\UserRegisteredConsumer::class,
        ],
    ],

    'producers' => [
        'default' => [
            'bootstrap.servers' => env('KAFKA_BROKERS', 'kafka:9092'),
        ],
    ],
